...
module.exports = {
    ...
    async listByCoach(request, response) {
        ...
        try {
            ...
            console.trace(error);
            // Pour l'utilisateur on affiche une erreur générique  
            // lui spécifiant qu'une erreur serveur s'est produite.
            response.json({data: [], error: `Désolé une erreur serveur 
